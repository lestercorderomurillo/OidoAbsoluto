...
use Pipeline\Factory\ComponentFactory;
use Pipeline\Factory\HTMLFactory;
...
class ViewRenderer
{
    ...
    private function includeJavascriptScripts(): InternalResult
    {
    ...
    {
        $html = $result->getData("html");
        foreach (($result->getData("view"))->getViewData() as $key => $value) {
            if (!is_array($value)) {
