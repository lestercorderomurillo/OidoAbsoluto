...
class BodySelection
{
    ...
    public function &setStartPosition(int $position): BodySelection
    {
        $this->start = max($position, 0);
        return $this;
    }

    public function &setEndPosition(int $position): BodySelection
    {
        $this->end = $position;
        return $this;
    }

    public function &moveStartPosition(int $offset = 1): BodySelection
    {
        $this->start += $offset;
    ...
    public function &moveEndPosition(int $offset = 1): BodySelection
    {
        $this->end += $offset;
        return $this;
    }
