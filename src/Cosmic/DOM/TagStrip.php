...
use Cosmic\DOM\DOM;
use Cosmic\Traits\StringsingableTrait;
        ...
        foreach ($this->attributes as $key => $value) {
            ...
            if (is_int($key)) {
                ...
                if (str_starts_with($key, "(") && str_ends_with($key, ")")) {
                    ...
                    app()->get(Bindings::class)->registerJavascriptSourceCode($handleCode);
                } else if (StrcontainsOne($key, ["id", "name", "for", "key"])) {
